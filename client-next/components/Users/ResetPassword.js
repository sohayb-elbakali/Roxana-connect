...
function ResetPassword() {
  ...
  const handlePasswordChange = (e) => {
    ...
    // Check if confirm password exists and doesn't match
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setMessage(res.data.msg || "Password reset successful! You can now login with your new password.");
      
      // Redirect to login after 3 seconds to give user time to see the message
      setTimeout(() => {
        router.push("/login");
      }, 3000);
    } catch (err) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {/* Success Message */}
          {message && (
            <div className="mb-6 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-300 rounded-xl p-5 shadow-lg animate-pulse">

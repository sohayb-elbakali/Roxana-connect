...
import { updateTrackingStatus } from "../../lib/redux/modules/tracking";
...
const StatusSelector = ({ trackingId, currentStatus, updateTrackingStatus }) => {
  ...
  return (
    <div className="relative">
      ...
      {showConfirmation && (
        <div 
          className="fixed inset-0 backdrop-blur-sm flex items-center justify-center z-50 animate-fadeIn" style={{ backgroundColor: 'rgba(0, 0, 0, 0.6)' }}
          role="dialog"
          aria-modal="true"

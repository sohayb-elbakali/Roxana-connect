      ...
      <div className="space-y-3">
        <div>
          ...
          <input
            ...
            className="text-gray-900 bg-white w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition-all duration-200"
          />
        </div>
        <div>
